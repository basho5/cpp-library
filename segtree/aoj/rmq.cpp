...
struct lazy_segtree {
  public:
    ...
    // 必要に応じて max_right, min_left なども実装可

  private:
    int _n, size, log;
    std::vector<S> d;    // ノード(区間)のデータ
    std::vector<F> lz;   // 遅延配列
